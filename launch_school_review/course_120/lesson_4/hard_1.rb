...
# Question 1. Alyssa has been assigned a task of modifying a class that was 
# initially created to keep track of secret information. The new requirement 
# calls for adding logging, when clients of the class attempt to access the 
