...
# repeatedly until a certain number of lines have been printed. Our solution looked like 
# this:
...
# new number each time through. The program should keep running until the user enters q 
# or Q.
