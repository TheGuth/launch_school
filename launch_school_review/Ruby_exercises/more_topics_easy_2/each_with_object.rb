...
# associated block. The value returned by the block is not used. The object 
# that is passed to the block is defined as an argument to each_with_obect; 
# with each iteration, this object may be updated by the block. When iteration 
