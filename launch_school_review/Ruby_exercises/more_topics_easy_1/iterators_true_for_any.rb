...
# returns a value of true for any element, then #any? returns true. 
# Otherwise, #any? returns false. Note in particular that #any? will 
...
# return true if the block returns true for any of the element values. 
